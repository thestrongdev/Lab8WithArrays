...
namespace Lab8Goodson
{
    class Program
    {
        ...
        static void GetUserRequest()
        {
            ...
            string[] classmates = new[] {"SAM", "IVAN", "THERESA", "MIKE", "VERKEIA", "CIARRA",
        ...
        static bool GetFact(int studentID, string [] classmates)
        {
        ...
        static string GetStudentName(string [] classmates, int studentID)
        {
        ...
        static void GetStudentInfo(int studentID, string fact, string name) //really wanted to try out generics here for allowing entry of name or ID. couldn't figure it out though.
        {
            ...
            string[] randomFacts = new[] {"didn't want more than one kid",
                                        "studied c++ in school",
            ...
            int[] studentAges = new[] {91, 85, 78, 94, 88, 66,
                                       75, 99, 102, 73, 80, 89 };

            

            string[] hometowns = {"Candyland", "Hogwarts", "Bikini Bottom",
